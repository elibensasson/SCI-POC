...
{
	_ntl_verylong modcon = 0;
	_ntl_verylong a=0, b=0;
	long anegative = 0;
	long bnegative = 0;
...
/* versions of gmp prior to version 3 have really bad xgcd */
   if (_ntl_gmp_hack && 
      ...
      _ntl_verylong xa1 = 0, xb1 = 0, d1 = 0, b_red = 0;
      _ntl_verylong tmp1 = 0, tmp2 = 0, tmp3 = 0;
	  ...
	  _ntl_zfree(&a);
	  _ntl_zfree(&b);
	  _ntl_zfree(&xa1); _ntl_zfree(&xb1); _ntl_zfree(&d1); _ntl_zfree(&b_red);
	  _ntl_zfree(&tmp1); _ntl_zfree(&tmp2); _ntl_zfree(&tmp3);
	  return;
   }
#endif
#endif
   ...
   )
{
   ...
   _ntl_verylong inv = 0;
   _ntl_verylong u = 0;
   _ntl_verylong a_bak = 0;
   _ntl_verylong n_bak = 0;
   _ntl_verylong inv_bak = 0;
   _ntl_verylong w_bak = 0;
   ...
   while (1)
   {
      sa = w[0];
      if (sa < 0) w[0] = -sa;
      if (w[0] >= sden && _ntl_zcompare(w, den_bound) > 0) {
		  loop_res = 0;
		  break;
	  }
      w[0] = sa;
