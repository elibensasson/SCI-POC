...
#include "reductions/TinyRAMtoBREX/RamToContraintSystem/ALU.hpp"

namespace PCP_Project{

	MemoryConstraints::MemoryConstraints(ProtoboardPtr pb,
		const  MemoryFollowingTraceVariables& followingTraceVariables) :
		Gadget(pb), first_(followingTraceVariables.first_), second_(followingTraceVariables.second_),
		unpackedaddr1_(unpackedArg1_), unpackedaddr2_(unpackedArg2_),
		unpackedTimestamp1_(opcodeAux1_), unpackedTimestamp2_(opcodeAux2_),
		addressFlags_(opcodeAux3_), timestampFlags_(opcodeAux4_),
		addressIsGEQ_(opcodeAux3_[0]), timestampIsGEQ_(opcodeAux4_[0]),
		multPartials1_(opcodeAux5_), multPartials2_(opcodeAux6_){}
