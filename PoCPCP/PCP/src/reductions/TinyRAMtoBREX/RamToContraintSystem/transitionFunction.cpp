...
TransitionFunction::TransitionFunction(ProtoboardPtr pb,
		...
		Gadget(pb),followingTraceVariable_(followingTraceVariable),inputTraceLine_(followingTraceVariable.first_), 
		outputTraceLine_(followingTraceVariable.second_), program_(program),
...
void TransitionFunction::generateWitness(unsigned int i){
	...
	GADGETLIB_ASSERT(codeLineNumber < program_.size(), "TransitionFunction: The code line number should be less than program.size()");
