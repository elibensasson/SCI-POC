...
public:
	...
	Element** subspaces;
	/*
	 * This is just a preallocated free space, used mostly for the partition phase.
	 */
	Element* c_p_cpy;
#ifdef __GPU
	/*
	 ...
	 */
	void fft_serial(Polynomial P,len_t log_size, Element* c_p_cpy);
	/*
	 ...
	 */
	void GPartition_cpu(Element* G, len_t log_g_len,Element* res);
	/*
	 ...
	 */
	void GPartition_cpuOMP(Element* G, len_t log_g_len,Element* res);
	/*
	 ...
	 */
	void WFromUV_cpu(Polynomial P, len_t log_g_len, len_t size);
	/*
	 * Serial WFromUV implementation - for lower levels of FFT.
	 */
	void WFromUV_cpu_serial(Polynomial P, len_t log_g_len, len_t size);
	/*
...
static void generateSubspaceElements_cpu(const Element* b,const Element& s,const len_t b_len,Element* const  res);
	 ...
	 */
	void AlgFFT(Polynomial* P, len_t p_len);
