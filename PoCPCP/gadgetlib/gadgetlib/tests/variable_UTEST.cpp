...
TEST(ConstraintsLib, FElem_LD2_Elem) {
    ...
    EXPECT_TRUE(1 != e0);
    //FElem& operator*=(const FElem& other) {*elem_ *= *other.elem_; return *this;}
    ::NTL::GF2X g0, g1, g2, g3;
    g0 = g1 = g2 = g3 = ::NTL::to_GF2X(0);
    ::NTL::SetCoeff(g0, 0);
    ::NTL::SetCoeff(g1, 1);
    ::NTL::SetCoeff(g2, 2);
    ::NTL::SetCoeff(g3, 1);
    ...
    //FElem inverse() const;
    e3 = e3 = to_GF2E(g3);
    EXPECT_EQ(e3.inverse(LD2), FElem(inv(to_GF2E(g3))));
...
TEST(ConstraintsLib, LinearTerm) {
    ...
    LinearTerm lt8(x[8], ::NTL::to_GF2E(1));
    ...
    // LD2
    LinearTerm lt21(x[0], to_GF2E(0));
    EXPECT_EQ(lt21.asString(), "0 * x[0]");
    LinearTerm lt22(x[0], to_GF2E(1));
    EXPECT_EQ(lt22.asString(), "x[0]");
    ::NTL::GF2X g0;
    ::NTL::SetCoeff(g0, 1);
    LinearTerm lt23(x[0], to_GF2E(g0));
...
TEST(ConstraintsLib, Monomial) {
    ...
    Monomial m2 = Monomial(::NTL::to_GF2E(1));
